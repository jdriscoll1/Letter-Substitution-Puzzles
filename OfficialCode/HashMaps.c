...
FILE *OpenFile(){
	char* wordDocuments[3] = {"WordDocuments/Two_Letter_Connections.txt", "WordDocuments/Three_Letter_Connections.txt", "WordDocuments/t/a.txt"};//"WordDocuments/Four_Connections_Int.txt"};
